...
static int calledShotSelectHitLocation(Object* critter, int* hitLocation, int hitMode)
{
    ...
    for (int index = 0; index < 4; index++) {
        ...
        btn = buttonCreate(gCalledShotWindow, 33, _call_ty[index] - 90, 128, 20, index, index, -1, index, nullptr, nullptr, nullptr, 0, offsetLeft);
        ...
        btn = buttonCreate(gCalledShotWindow, 341, _call_ty[index] - 90, 128, 20, index + 4, index + 4, -1, index + 4, nullptr, nullptr, nullptr, 0, offsetRight);
        buttonSetMouseCallbacks(btn, _draw_loc_on_, _draw_loc_off, nullptr, nullptr);
