...
#define SFALL_CONFIG_START_XPOS "StartXPos"
#define SFALL_CONFIG_START_YPOS "StartYPos"
#define SFALL_CONFIG_START_VIEWXPOS "ViewXPos"
#define SFALL_CONFIG_START_VIEWYPOS "ViewYPos"
